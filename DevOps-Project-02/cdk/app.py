...
config = {
    "your_ip": "148.216.54.186/32",  # Reemplaza con tu IP pública en formato CIDR (ejemplo: 
    
    "region": "us-east-1",  # Reemplaza con tu región preferida

    "global_ami_id": "ami-0facf7ae61f89a691",  # Reemplaza con el ID de tu Golden AMI
    "key_pair_name": "DevOpsKeyPair",

    "domain_name": "congress.mx",  # Reemplaza con tu dominio registrado en Route53
}
